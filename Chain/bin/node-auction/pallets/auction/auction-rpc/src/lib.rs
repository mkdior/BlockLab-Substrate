...
#[rpc]
pub trait AuctionInformationAPI<BlockHash, AuctionId>//AccountId, AuctionId, Balance, BlockNumber, GeneralInfo>
{
...
impl<C, Block, AuctionId>//AccountId, AuctionId, Balance, BlockNumber, GeneralInfo>
...
where
    ...
    C::Api: AuctionWrapperAPI<Block, AuctionId>,//AccountId, AuctionId, Balance, BlockNumber, GeneralInfo>,
//    AccountId: Codec,
    AuctionId: Codec,
//    Balance: Codec,
//    BlockNumber: Codec,
