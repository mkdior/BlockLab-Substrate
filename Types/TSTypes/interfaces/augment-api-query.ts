...
import { AuctionId, AuctionInfo, QueuedBid } from 'sample-polkadotjs-typegen/interfaces/auctions';
import { ApiTypes } from '@polkadot/api/types';

declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    auctionModule: {
      auctionEndTime: AugmentedQueryDoubleMap<ApiType, (key1: BlockNumber | AnyNumber | Uint8Array, key2: AuctionId | AnyNumber | Uint8Array) => Observable<Option<bool>>>;
      auctions: AugmentedQuery<ApiType, (arg: AuctionId | AnyNumber | Uint8Array) => Observable<Option<AuctionInfo>>>;
      auctionsIndex: AugmentedQuery<ApiType, () => Observable<AuctionId>>;
      queuedBids: AugmentedQuery<ApiType, (arg: BlockNumber | AnyNumber | Uint8Array) => Observable<Option<QueuedBid>>>;
    };
    balances: {
      /**
