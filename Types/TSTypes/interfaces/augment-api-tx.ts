...
import { AccountId, Balance, BalanceOf, BlockNumber, Call, ChangesTrieConfiguration, KeyValue, LookupSource, Moment, Perbill, Weight } from '@polkadot/types/interfaces/runtime';
import { Key } from '@polkadot/types/interfaces/system';
import { AuctionId, GeneralInformationContainer } from 'sample-polkadotjs-typegen/interfaces/auctions';
import { ApiTypes, SubmittableExtrinsic } from '@polkadot/api/types';

declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    auctionModule: {
      bid: AugmentedSubmittable<(id: AuctionId | AnyNumber | Uint8Array, value: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      extNewAuction: AugmentedSubmittable<(terminal: AccountId | string | Uint8Array, numCon: GeneralInformationContainer | AnyNumber | Uint8Array, numTeu: GeneralInformationContainer | AnyNumber | Uint8Array, timestamp: GeneralInformationContainer | AnyNumber | Uint8Array, start: BlockNumber | AnyNumber | Uint8Array, end: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      extRemoveAuction: AugmentedSubmittable<(id: AuctionId | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      extUpdateAuction: AugmentedSubmittable<(id: AuctionId | AnyNumber | Uint8Array, time: Option<GeneralInformationContainer> | null | object | string | Uint8Array, numCon: Option<GeneralInformationContainer> | null | object | string | Uint8Array, numTeu: Option<GeneralInformationContainer> | null | object | string | Uint8Array, start: Option<BlockNumber> | null | object | string | Uint8Array, end: Option<BlockNumber> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    balances: {
      /**
