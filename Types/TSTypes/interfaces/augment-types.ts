...
import { AuctionCoreInfo, AuctionId, AuctionInfo, Currency, GenInfo, GeneralInformationContainer, OnNewBidResult, QueuedBid, Status, UIAuctionInfo } from 'sample-polkadotjs-typegen/interfaces/auctions';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Compact<GeneralInformationContainer>': Compact<GeneralInformationContainer>;
    'Option<GeneralInformationContainer>': Option<GeneralInformationContainer>;
    'Vec<GeneralInformationContainer>': Vec<GeneralInformationContainer>;
    GenInfo: GenInfo;
    'Option<GenInfo>': Option<GenInfo>;
    'Vec<GenInfo>': Vec<GenInfo>;
    Status: Status;
    ...
    QueuedBid: QueuedBid;
    'Option<QueuedBid>': Option<QueuedBid>;
    'Vec<QueuedBid>': Vec<QueuedBid>;
    AuctionCoreInfo: AuctionCoreInfo;
    'Option<AuctionCoreInfo>': Option<AuctionCoreInfo>;
    'Vec<AuctionCoreInfo>': Vec<AuctionCoreInfo>;
    AuctionInfo: AuctionInfo;
    'Option<AuctionInfo>': Option<AuctionInfo>;
    'Vec<AuctionInfo>': Vec<AuctionInfo>;
    UIAuctionInfo: UIAuctionInfo;
    'Option<UIAuctionInfo>': Option<UIAuctionInfo>;
    'Vec<UIAuctionInfo>': Vec<UIAuctionInfo>;
    OnNewBidResult: OnNewBidResult;
    'Option<OnNewBidResult>': Option<OnNewBidResult>;
    'Vec<OnNewBidResult>': Vec<OnNewBidResult>;
  }
}
